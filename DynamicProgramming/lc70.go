...
//2 steps + 1 step
//Approach
//This problem is a classic example of dynamic programming, often referred to as the "staircase problem". It is similar to the Fibonacci sequence, where the number of ways to reach the nth step is the sum of the ways to reach the (n-1)th step and the (n-2)th step:
//
//Base Cases:
//If n == 1, there is only 1 way to climb the staircase.
//Dynamic Programming Initialization:
//Use a DP array dp where dp[i] represents the number of ways to climb to the ith step.
...
func main() {
	...
	fmt.Println(climbStairs(123456))
